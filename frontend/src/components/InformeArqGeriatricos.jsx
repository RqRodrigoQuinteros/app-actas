...
const SECCIONES = [
  ...
  },
  {
    ...
    campos: [
      ...
      { id: "cantCamas",   label: "Cantidad de camas (Declaradas)",          placeholder: "22" },
      { id: "cantUTIGral",    label: "Cant. unidades UTI Generales",          tipo: "numero", placeholder: "0" },
      { id: "cantUTIAisladas",    label: "Cant. unidades UTI Aisladas",          tipo: "numero", placeholder: "0" },
      { id: "cantUCOGral",    label: "Cant. unidades UCO Generales",          tipo: "numero", placeholder: "0" },
      { id: "cantUCOAisladas",    label: "Cant. unidades UCO Aisladas",          tipo: "numero", placeholder: "0" },
      { id: "cantUCIGral",    label: "Cant. unidades UCI Generales",          tipo: "numero", placeholder: "0" },
      { id: "cantUCIAisladas",    label: "Cant. unidades UCI Aisladas",          tipo: "numero", placeholder: "0" },
      { id: "cantUTIPGral",   label: "Cant. unidades UTIP Generales",         tipo: "numero", placeholder: "0" },
